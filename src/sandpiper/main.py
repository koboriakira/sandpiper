...
def obsidian_list(
    ...
    """Obsidian Inboxのノートを一覧表示します"""  # noqa: RUF002
...
def obsidian_complete(
    page_id: str = typer.Argument(..., help="NotionページID"),
) -> None:
    """Obsidian InboxノートのステータスをXに設定します"""  # noqa: RUF002
    from lotion import Lotion
    ...
    console.print(f"[green]ステータスを「移行済」に更新しました: {page_id}[/green]")
